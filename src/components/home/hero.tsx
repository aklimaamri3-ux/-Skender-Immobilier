...
export function Hero({
  ...
  return (
    <section className="relative flex min-h-[92vh] items-center overflow-hidden bg-noir">
      {heroImageUrl ? (
        <div
      ...
      <div className="section-container absolute inset-x-0 bottom-8 z-10 flex flex-wrap items-center justify-between gap-4 text-xs text-blanc/70">
        {location && (
